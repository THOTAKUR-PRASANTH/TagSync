      ...
      <div className="flex flex-col h-full z-10 relative">
        <div className="flex items-center gap-4 mb-4">
          <div className={`p-3 rounded-xl bg-gradient-to-br ${darkMode ? gradient : lightGradient} shadow-lg
            group-hover:scale-110 transform transition-all duration-300 group-hover:shadow-xl`}>
            {React.isValidElement(icon)
              ? React.cloneElement<React.SVGProps<SVGSVGElement>>(icon as React.ReactElement<React.SVGProps<SVGSVGElement>>, { className: "w-6 h-6 text-white" })
              : icon}
          </div>
        ...
        <button
          ...
          className={`flex items-center text-sm font-semibold transition-all duration-300 cursor-pointer
            ${darkMode ? 'text-purple-400 hover:text-purple-300' : 'text-purple-600 hover:text-purple-800'}`}>
          Manage
          <ChevronRight className="w-4 h-4 ml-1 animate-chevron transition-transform duration-300" />
        </button>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative mb-12 text-center">
      ...
      <div className={`relative backdrop-blur-lg rounded-3xl p-8 shadow-2xl transition-all duration-500
        ...
        >
          <h1 className="text-3xl font-bold mb-2 flex flex-wrap items-center justify-center gap-2">
