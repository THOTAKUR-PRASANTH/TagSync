...
export default function SecurePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h1 className="text-4xl font-extrabold tracking-wide text-white mb-2 drop-shadow-lg">
          📊 Analytics Dashboard
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <motion.div
            ...
            className={`${stat.color} rounded-2xl shadow-xl p-6 text-center text-white`}
          >
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-xl p-6"
      >
        ...
        <div className="space-y-4">
          {activities.map((item, index) => (
            <motion.div
              ...
              transition={{ delay: index * 0.1 }}
              className="flex items-center justify-between p-4 bg-gray-700/60 rounded-lg hover:bg-gray-700 transition-colors"
            >
